...
import avatarImage from '@site/src/images/avatar.jpg'
...
export function Header() {
  let isHomePage = true; //usePathname() === '/'
  ...
  return (
    <>
      <header
        className="pointer-events-none relative z-50 flex flex-none flex-col navbar"
        style={{
